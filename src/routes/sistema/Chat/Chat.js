...
const users = [
    {
      ...
      lastMessage: 'Necesito Ayuda sobre algunos pendientes',
      unreadMessage: '4',
      lastMessageTime: 'Hoy',
      recent: true
    }, {
      ...
      lastMessage: 'Hola quiero hablar con alguien porfavor ',
      unreadMessage: '',
      ...
      lastMessage: 'Estoy buscando la promoción X en la sucursal ',
      unreadMessage: '3',
      lastMessageTime: 'Ayer',
      recent: true
    }, {
...
const conversationList = [
    {
      ...
      'conversationData': [
        {
          'type': 'sent',
          'message': 'Hola busco ayuda',
          'sentAt': '3:03:28 PM',
        },
        {
          'type': 'received',
          'message': 'No hay problema me podrias dar tu nombre',
          'sentAt': '3:05:47 PM',
        },
        {
          'type': 'sent',
      ...
      'conversationData': [
        {
          ...
          'type': 'received',
          'message': 'Hola que tal? Necesita ayuda en algo ',
          'sentAt': '3:10:28 PM',
        }
      ]
    },
    {
      ...
      'conversationData': [
        {
          'type': 'sent',
          'message': 'Estoy buscando la promoción X en la sucursal ',
          'sentAt': '3:03:28 PM',
        },
      ]
    }, {
      ...
      'conversationData': [
        {
          ...
          'type': 'sent',
          'message': 'Hola buenas necesito ayuda',
          'sentAt': '3:08:35 PM',
        }, {
          'type': 'received',
          'message': 'Claro digame su duda ',
          'sentAt': '3:10:28 PM',
        }, {
          'type': 'sent',
          'message': 'Otros pendientes',
          'sentAt': '3:11:25 PM',
        }
      ]
    },
    ...
    return <div className="gx-chat-sidenav-main">
      <div className="gx-bg-grey-light gx-chat-sidenav-header">
        ...
        <div className="gx-chat-user gx-chat-user-center">
          ...
          <div className="gx-user-name h4 gx-my-2">Gerson Vilca Alvarez</div>
        ...
        <div className="gx-chat-user-hd">
          ...
          <div className="gx-module-user-info gx-flex-column gx-justify-content-center">
            <div className="gx-module-title">
              <h5 className="gx-mb-0">Gerson Vilca Alvarez</h5>
            </div>
            <div className="gx-module-user-detail">
              <span className="gx-text-grey gx-link">Administrador</span>
            </div>
          </div>
        </div>
      ...
      <div className="gx-chat-box">
        {this.state.selectedUser === null ?
          <div className="gx-comment-box">
            ...
            <h1 className="gx-text-muted">{"Selecciona un chat"}</h1>
